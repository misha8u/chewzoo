...
export const initialState = {
  ...
  branchDone: false,
  branchError: null,
  returnScrollLoading: false,
  returnScrollDone: false,
  returnScrollError: null,
  focusCard: 0,
};
...
export const RETURN_SCROLL_REQUEST = 'RETURN_SCROLL_REQUEST';
export const RETURN_SCROLL_SUCCESS = 'RETURN_SCROLL_SUCCESS';
export const RETURN_SCROLL_FAILURE = 'RETURN_SCROLL_FAILURE';
...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    case RETURN_SCROLL_REQUEST:
      draft.returnScrollLoading = true;
      draft.returnScrollDone = false;
      draft.returnScollError = null;
      break;
    case RETURN_SCROLL_SUCCESS:
      draft.focusCard = action.data;
      draft.returnScrollLoading = false;
      draft.returnScrollDone = true;
      break;
    case RETURN_SCROLL_FAILURE:
      draft.returnScrollLoading = false;
      draft.returnScrollError = action.error;
      break;
    case BRANCH_REQUEST:
